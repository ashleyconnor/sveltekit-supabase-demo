...
var require_types = __commonJS({
  '.svelte-kit/cloudflare-workers/node_modules/@cloudflare/kv-asset-handler/dist/types.js'(
    ...
    exports2.InternalError =
      exports2.NotFoundError =
      exports2.MethodNotAllowedError =
      exports2.KVError =
        void 0;
...
var require_dist = __commonJS({
  '.svelte-kit/cloudflare-workers/node_modules/@cloudflare/kv-asset-handler/dist/index.js'(
    ...
    exports2.InternalError =
      exports2.NotFoundError =
      exports2.MethodNotAllowedError =
      exports2.serveSinglePageApp =
      exports2.mapRequestToAsset =
      exports2.getAssetFromKV =
        void 0;
    var mime = require_mime();
    var types_1 = require_types();
    Object.defineProperty(exports2, 'MethodNotAllowedError', {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports2, 'InternalError', {
      enumerable: true,
      get: function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              ASSET_MANIFEST =
                typeof options2.ASSET_MANIFEST === 'string'
                  ? JSON.parse(options2.ASSET_MANIFEST)
                  : options2.ASSET_MANIFEST;
              ...
              if (!SUPPORTED_METHODS.includes(request.method)) {
                throw new types_1.MethodNotAllowedError(
                  request.method + ' is not a valid request method'
                );
              }
            ...
            case 5:
              ...
              if (shouldSetBrowserCache) {
                response.headers.set(
                  'Cache-Control',
                  'max-age=' + options2.cacheControl.browserTTL
                );
              } else {
...
var metadata_lookup = {
  ...
  'src/routes/todos/index.svelte': {
    ...
    js: ['/./_app/pages/todos/index.svelte-faeed37c.js', '/./_app/chunks/vendor-2f7c43bc.js'],
    styles: null
  }
};
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="${'svelte-1twf6mk'}"><div class="${'corner svelte-1twf6mk'}"><a href="${'https://kit.svelte.dev'}" class="${'svelte-1twf6mk'}"><img${add_attribute(
    'src',
    logo,
    0
	...
	<nav class="${'svelte-1twf6mk'}"><svg viewBox="${'0 0 2 3'}" aria-hidden="${'true'}" class="${'svelte-1twf6mk'}"><path d="${'M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z'}" class="${'svelte-1twf6mk'}"></path></svg>
		<ul class="${'svelte-1twf6mk'}"><li class="${['svelte-1twf6mk', $page.path === '/' ? 'active' : '']
    .join(' ')
    .trim()}"><a sveltekit:prefetch href="${'/'}" class="${'svelte-1twf6mk'}">Home</a></li>
			<li class="${['svelte-1twf6mk', $page.path === '/about' ? 'active' : '']
        .join(' ')
        .trim()}"><a sveltekit:prefetch href="${'/about'}" class="${'svelte-1twf6mk'}">About</a></li>
			<li class="${['svelte-1twf6mk', $page.path === '/todos' ? 'active' : '']
        .join(' ')
...
var Counter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${'counter svelte-ltn89m'}"><button aria-label="${'Decrease the counter by one'}" class="${'svelte-ltn89m'}"><svg aria-hidden="${'true'}" viewBox="${'0 0 1 1'}" class="${'svelte-ltn89m'}"><path d="${'M0,0.5 L1,0.5'}" class="${'svelte-ltn89m'}"></path></svg></button>
    ...
    'transform: translate(0, ' + escape2(100 * offset) + '%)'
  }"><strong style="${'top: -100%'}" aria-hidden="${'true'}" class="${'svelte-ltn89m'}">${escape2(
...
<div class="${'todos svelte-dmxqmd'}"><h1>Todos</h1>
    ...
    (todo) => `<div class="${['todo svelte-dmxqmd', todo.done ? 'done' : '']
      .join(' ')
      .trim()}"><form action="${
      '/todos/' + escape2(todo.uid) + '.json?_method=patch'
      ...
      'Mark todo as ' + escape2(todo.done ? 'not done' : 'done')
    }"></button></form>
      ...
      0
			...
			<form action="${
        '/todos/' + escape2(todo.uid) + '.json?_method=delete'
